...
class TestCallRetrievalService:
    ...
    @pytest.mark.asyncio
    async def test_call_retrieval_service_with_custom_top_k(self, chat_processor_service, mocker):
    ...
    @pytest.mark.asyncio
    async def test_call_retrieval_service_empty_chunks(self, chat_processor_service, mocker):
    ...
    @pytest.mark.asyncio
    async def test_call_retrieval_service_http_exception(self, chat_processor_service, mocker):
    ...
    @pytest.mark.asyncio
    async def test_call_retrieval_service_validation_error(self, chat_processor_service, mocker):
    ...
    @pytest.mark.asyncio
    async def test_call_retrieval_service_unexpected_error(self, chat_processor_service, mocker):
...
class TestCallGenerationService:
    ...
    @pytest.mark.asyncio
    async def test_call_generation_service_success(self, chat_processor_service, mocker):
    ...
    @pytest.mark.asyncio
    async def test_call_generation_service_empty_context(self, chat_processor_service, mocker):
    ...
    @pytest.mark.asyncio
    async def test_call_generation_service_filters_none_text(self, chat_processor_service, mocker):
    ...
    @pytest.mark.asyncio
    async def test_call_generation_service_http_exception(self, chat_processor_service, mocker):
    ...
    @pytest.mark.asyncio
    async def test_call_generation_service_unexpected_error(self, chat_processor_service, mocker):
...
class TestProcessMethod:
    ...
    async def test_process_success(self, chat_processor_service, mocker):
        ...
        mock_generation.assert_called_once_with(
            ...
            context_chunks=[{"text": "retrieved chunk"}]
        )

        assert result == "Generated response"

    @pytest.mark.asyncio
    async def test_process_empty_retrieval_results(self, chat_processor_service, mocker):
    ...
    async def test_process_retrieval_failure(self, chat_processor_service, mocker):
        ...
        mocker.patch.object(
            chat_processor_service,
            "_call_retrieval_service",
            side_effect=HTTPException(status_code=503, detail="Retrieval service unavailable")
        )
    ...
    async def test_process_generation_failure(self, chat_processor_service, mocker):
        ...
        mocker.patch.object(
            chat_processor_service,
            "_call_generation_service",
            side_effect=HTTPException(status_code=500, detail="Generation service error")
        )
    ...
    @pytest.mark.asyncio
    async def test_process_unexpected_generation_error(self, chat_processor_service, mocker):
