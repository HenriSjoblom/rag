...
Provides fixtures and test client setup with proper mocking.
"""
...
def test_client(mock_app, integration_settings):
    ...
    mock_app.dependency_overrides[get_settings] = lambda: integration_settings
...
def client_with_mocked_services(
    ...
    mock_app.dependency_overrides[get_settings] = lambda: integration_settings
    mock_app.dependency_overrides[get_ingestion_state_service] = lambda: mock_state_service
    mock_app.dependency_overrides[get_file_management_service] = lambda: mock_file_service
    mock_app.dependency_overrides[get_collection_manager_service] = lambda: mock_collection_service
    mock_app.dependency_overrides[get_ingestion_processor_service] = lambda: mock_ingestion_processor
